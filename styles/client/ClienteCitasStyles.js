...
const createStyles = (width, theme) => {
  ...
  return StyleSheet.create({
    ...
    // tableCard: quita fondo/sombra en móvil, solo en desktop
    tableCard: {
      backgroundColor: isSmall ? "transparent" : CARD_BG,
      borderRadius: isSmall ? 0 : 20,
      padding: isSmall ? 0 : 20,
      ...(isSmall
        ? {}
        : isWeb
          ? {
    ...
    // mobileCard: fondo blanco sólido, sombra única y más suave, menos padding
    mobileCard: {
      backgroundColor: CARD_BG, // blanco sólido, no rgba tenue
      borderRadius: 16,
      padding: 14,
      marginBottom: 10,
      borderWidth: 0, // quitamos el borde, la sombra ya delimita
      ...(isWeb
    ...
    mobileCardHeader: {
      ...
      alignItems: "center",
      justifyContent: "space-between",
      marginBottom: 6, // antes 8, poco cambio pero ayuda
    },
