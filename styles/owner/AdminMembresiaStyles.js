...
const createStyles = (width, theme) => {
  ...
  return StyleSheet.create({
    ...
    estadoDotActive: { backgroundColor: ACTIVE_GREEN },
    estadoDotInactive: { backgroundColor: DANGER_RED },
    estadoText: { color: WHITE, fontSize: 15, fontWeight: "700" },
    ...
    metodoPillInactive: { backgroundColor: PILL_INACTIVE },
    metodoPillActive: { backgroundColor: PILL_ACTIVE_BG },
    metodoPillText: { fontSize: 12, fontWeight: "700", color: WHITE },
    metodoPillTextActive: { color: PILL_ACTIVE_TEXT },
