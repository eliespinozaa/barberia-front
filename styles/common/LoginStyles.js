...
borderColor: '#D8D8D8',
    ...
    overflow: 'hidden',   // evita que el texto se salga del borde
  },
  input: {
    flex: 1,
    minWidth: 0,          // clave: permite que flex reduzca el input correctamente
     color: '#000',
    fontSize: isSmallScreen ? 13 : 14,
    ...(isWeb && { outlineWidth: 0 }),
  },
  eyeBtn: {
    flexShrink: 0,        // el ojito nunca se encoge ni se desplaza
    padding: 4,
    marginLeft: 6,
  },
