...
const ACCESOS_DIRECTOS = [
  {
    ...
    desc: "Consulta y gestiona las citas programadas del día.",
    screen: "AdminCitasScreen",
  },
  {
    titulo: "Clientes",
    desc: "Registra y elimina a clientes de manera rápida.",
    screen: "AdminClientesScreen",
  },
  {
    titulo: "Barberos",
    desc: "Agrega, edita o elimina a los barberos de tu equipo.",
    screen: "AdminBarberosScreen",
  },
  {
    titulo: "Servicios",
    desc: "Administra el catálogo de servicios que ofrecemos en nuestra barbería",
    screen: "AdminServiciosScreen",
  },
  {
    titulo: "Promociones",
    desc: "Crea nuevas promociones y así obtener nuevas visitas",
    screen: "AdminPromocionesScreen",
  },
  {
    titulo: "Horarios",
    desc: "Define y ajusta los horarios de atención de tu barbería.",
    screen: "AdminHorariosScreen",
  },
  {
    titulo: "Membresía",
    desc: "Revisa el estado y los pagos de tu membresía.",
    screen: "AdminMembresiaScreen",
  },
  {
    titulo: "Reseñas",
    desc: "Lee lo que opinan tus clientes sobre tu barbería.",
    screen: "AdminReseñasScreen",
  },
];
...
const OwnerHomeScreen = ({ navigation }) => {
  ...
  const STATS_ROW1 = [
    ...
    {
      label: "Ingresos",
      value: formatearIngresos(resumen?.ingresos),
      icon: "arrow-down-outline",
    },
    {
      label: "Promociones",
      value: resumen?.promociones ?? "—",
      icon: "flash-outline",
    },
  ];
