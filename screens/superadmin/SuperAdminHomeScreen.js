...
const ACCESOS_DIRECTOS = [
  {
    titulo: "Barberias",
    desc: "Administra de forma rapida el catálogo de barberias",
    screen: "BarberiasScreen",
  },
  {
    titulo: "Usuarios",
    desc: "Gestión de los usuarios",
    screen: "UsuariosScreen",
  },
  {
    titulo: "Membresias",
    desc: "Administra los pagos y suscripciones de manera rapida",
    screen: "MembresiasScreen",
  },
];
          ...
          <View style={styles.statsPanel}>
            ...
            <View style={styles.statsGrid}>
              {[
                {
                  label: "Barberias",
                  value: statsResumen.barberias,
                  icon: "storefront-outline",
                },
                {
                  label: "Clientes",
                  value: statsResumen.clientes,
                  icon: "people-outline",
                },
                {
                  label: "Activas",
                  value: statsResumen.activas,
                  icon: "checkmark-circle-outline",
                },
                {
                  label: "Suspendidas",
                  value: statsResumen.suspendidas,
            ...
            <View style={styles.statsGrid}>
              {[
                {
                  label: "Pagadas",
                  value: statsSuscripciones.pagadas,
                  icon: "checkmark-done-outline",
                },
                {
                  label: "Por vencer",
                  value: statsSuscripciones.porVencer,
                  icon: "warning-outline",
                },
                {
                  label: "Vencidas",
                  value: statsSuscripciones.vencidas,
                  icon: "close-circle-outline",
                },
              ].map((s) => (
                <View key={s.label} style={styles.statItem}>
